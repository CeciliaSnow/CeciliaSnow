<template>
  ...
  <!-- 详情弹窗 -->
  <el-dialog v-model="dd2" title="详情">
  ...
  <template #footer>
      <span class="dialog-footer">
        <el-button @click="dd2 = false">取消</el-button>
        <el-button type="primary" @click="dd2 = false;del()">继续任务</el-button>
      </span>
    </template>
  </el-dialog>
</template>
...
export default {
  ...
  methods: {
    load() {
      ...
      axioss.get("/work/fangqis2/" + this.user.id).then(res => {
        if (res.data.code === "0") {
